...
# ---------------------------------------------------------------------------
# Provider ID mapping: Hermes â†?models.dev
# ---------------------------------------------------------------------------

# Hermes provider names â†?models.dev provider IDs
...
# Reverse mapping: models.dev â†?Hermes (built lazily)
...
def _get_cache_path() -> Path:
    ...
    from ._compat import _HermesConstants as hermes_constants; # from hermes_constants import get_hermes_home
...
def fetch_models_dev(force_refresh: bool = False) -> Dict[str, Any]:
    ...
    # Fall back to disk cache â€?use a short TTL (5 min) so we retry
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    """
    # Resolve Hermes ID â†?models.dev ID
